...
nmcli con show
nmcli connection modify ens1f1np1 ipv4.method manual ipv4.addresses 10.1.1.14/24 ipv4.gateway 10.1.1.1 ipv4.dns 192.168.8.15,192.168.8.16 ipv4.dns-search o2pos.com
