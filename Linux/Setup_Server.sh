...
nmcli con show
nmcli connection modify enp3s0f0 ipv4.method manual ipv4.addresses 192.168.8.26/16 ipv4.gateway 192.168.8.1 ipv4.dns 192.168.8.15,192.168.8.16 ipv4.dns-search o2pos.com
