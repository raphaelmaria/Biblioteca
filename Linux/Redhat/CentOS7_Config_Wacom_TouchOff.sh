#!/bin/bash
## Desenvolvido em 01/30/19
## Link de referencia: https://knowledge.autodesk.com/support/flame-products/troubleshooting/caas/sfdcarticles/sfdcarticles/How-to-disable-the-Touch-Ring-and-ExpressKeys-for-a-Wacom-Tablet-on-CentOS-Linux-in-Flame.html
## Adaptado por Raphael Maria
## Em 01/08/2019 as 17h50m
##
