...
nmcli con show
nmcli connection modify "Wired connection 1" ipv4.method manual ipv4.addresses 192.168.8.68/16 ipv4.gateway 192.168.8.1 ipv4.dns 192.168.8.100,192.168.8.110 ipv4.dns-search o2pos.com.br
nmcli con up eth0
