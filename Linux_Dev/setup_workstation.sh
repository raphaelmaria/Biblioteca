...
nmcli con modify enp67s0 ipv4.method manual ipv4.addresses 192.168.10.45/16 ipv4.gateway 192.168.8.1 ipv4.dns 192.168.8.100,192.168.8.110,192.168.8.15 ipv4.dns-search o2pos.com.br
