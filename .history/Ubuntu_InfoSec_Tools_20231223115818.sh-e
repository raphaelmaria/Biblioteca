...
sudo apt -y install crackle dirb dhcpig dirsearch dnsmap ethtool exploitdb exploitdb-bin-sploits exploitdb-papers ext3grep extundelete forensic-artifacts 