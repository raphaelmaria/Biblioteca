...
sudo apt -y install sqlmap aircrack-ng airgraph-ng ettercap-common ettercap-graphical ettercap-text-only burpsuite wifite nikto netdiscover crunch wpscan wordlists john john-data tcpdumpsudo apt -y install firewalk netcat dnswalk dnsenum arpwatch whatweb spiderfoot impacket-scripts gophish bettercap airgeddon zenmap-kbx medusa ghidra apktool subfinder dirbuster dsniff
