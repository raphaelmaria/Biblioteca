...
sudo apt -y install crackle dirb dhcpig dirsearch dnsmap ethtool exploitdb exploitdb-bin-sploits exploitdb-papers ext3grep extundelete forensic-artifacts forensics-colorize fping fragrouter getallurls ghidra \
      gobuster google-nexus-tools gophish gparted gpart hak5-wifi-coconut hash-identifier hashdeep hashid hashrat hb-honeypot hosthunter httprint httprobe httpx-toolkit ismtp johnny joomscan jsql-injection kerberoast 