...
sudo apt -y install       libwireshark-data libwireshark-dev libwireshark17 libwiretap-dev libwiretap14 libwsutil-dev libwsutil15 tshark wireshark wireshark-common wireshark-dev wireshark-docsudo apt -y install sqlmap aircrack-ng airgraph-ng ettercap-common ettercap-graphical ettercap-text-only burpsuite wifite nikto netdiscover crunch wpscan wordlists john john-data tcpdump
