...
$pathATARI="$unidUSB\roms\"
$pathCPS="$unidUSB\roms\
$pathFC="$unidUSB\roms\
$pathGB="$unidUSB\roms\
$pathGBC="$unidUSB\roms\
$pathGBA="$unidUSB\roms\
$pathMD="$unidUSB\roms\
$pathps1="$unidUSB\roms\
$pathSFC="$unidUSB\roms\
$pathSMS="$unidUSB\roms\
$pathZ64="$unidUSB\roms\
