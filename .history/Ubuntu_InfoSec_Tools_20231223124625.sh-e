...
sudo apt -y install s3scanner python3-scapy sendemail smbmap smtp-user-enum snmpcheck snmpenum spectools sqlitebrowser sqlninja ssldump sslscan sslsniff sslsplit sslstrip sslyze tcpflow tcpflow-nox teamsploit terraform testdisk traceroute tzdata sudo apt -y install udptunnel bsdextrautils bsdutils fdisk util-linux util-linux-extra util-linux-locales
