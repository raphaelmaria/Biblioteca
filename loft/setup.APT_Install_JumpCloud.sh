...
# [Instalacao de Basicos]
    ...
    sudo curl --tlsv1.2 --silent --show-error --header 'x-connect-key: ef10c8ee36a34a414100d8c1eb2d93f26464acc5' https://kickstart.jumpcloud.com/Kickstart | sudo bash
    ...
    sudo /opt/CrowdStrike/falconctl -s --cid=1BE4CE2B4D1B49CD8A8647D08B261C9B-FB
